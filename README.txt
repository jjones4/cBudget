...
options to display your budget, add a record, or remove a record. Note that there is no
input validation yet. A session with the app might look something like this:
